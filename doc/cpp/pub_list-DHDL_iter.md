...
//
// Title-
//       ~/doc/cpp/pub_list-DHDL_iter.md
//
// Purpose-
//       List.h reference manual: DHDL_list iterator
//
// Last change date-
//       2025/10/05
//
...
## `pub::DHDL_list<T>::iterator` a.k.a. `pub::List<T>`

The DHDL_list<T>::iterator *does not* reference the DHDL_list,
and the DHDL_list *does not* reference the iterator.
The iterator only contains a pointer to the current DHDL_list<T>::Link.

Fields:
- pointer _link: The current Link

Where:<br/>
For a DHDL_list<T> const iterator:<br/>
- typedef const T* pointer;

For a DHDL_list<T> iterator:<br/>
- typedef T* pointer;
...
---
#### DHDL_list::iterator::iterator(void) noexcept;
Construct an end() iterator.
(All end() iterators compare equal.)

---
#### DHDL_list::iterator::iterator(DHDL_list*) noexcept;
Construct a begin() iterator.
The begin() iterator sets the iterator to the current head element.

---
#### DHDL_list::iterator::iterator(DHDL_list::iterator&) noexcept;
