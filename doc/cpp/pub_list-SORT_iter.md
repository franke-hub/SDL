...
//
// Title-
//       ~/doc/cpp/pub_list-SORT_iter.md
//
// Purpose-
//       List.h reference manual: DHDL_sort iterator
//
// Last change date-
//       2025/10/05
//
...
## `pub::DHDL_sort<T>::iterator`

The DHDL_sort<T>::iterator *does not* reference the DHDL_sort,
and the DHDL_sort *does not* reference the iterator.
The iterator only contains a pointer to the current DHDL_sort<T>::Link.

Fields:
- pointer _link: The current Link

Where:<br/>
For a DHDL_sort<T> const iterator:<br/>
- typedef const T* pointer;

For a DHDL_sort<T> iterator:<br/>
- typedef T* pointer;
...
---
#### DHDL_sort::iterator::iterator(void) noexcept;
Construct an end() iterator.
(All end() iterators compare equal.)

---
#### DHDL_sort::iterator::iterator(DHDL_sort*) noexcept;
Construct a begin() iterator.
The begin() iterator sets the iterator to the current head element.

---
#### DHDL_sort::iterator::iterator(DHDL_sort::iterator&) noexcept;
