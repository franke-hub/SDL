...
//
// Title-
//       ~/doc/cpp/pub_list-DHDL.md
//
// Purpose-
//       List.h reference manual: DHDL_list<T>
//
// Last change date-
//       2025/10/05
//
...
## `pub::DHDL_list<T>` a.k.a. `pub::List<T>`

See also: [`DHDL_list<T>::iterator`](./pub_list-DHDL_iter.md)

#### Definition: "link set"
A link set is a set of links bounded by a head and a tail link.
While a DHDL_list<T> contains an entire link set, portions of the list
...
#### Types:
- `DHDL_list<T>::struct Link`: The Link type

`DHDL_list<T>` Links are implemented using
`class T : public pub::DHDL_list<T>::Link {...};`
...
---
### <a id="example">Example:</a> Compare with [DHDL_sort example](./pub_list-SORT.md#example)
```
...
struct Item : public pub::DHDL_list<Item>::Link {
size_t                 value;
