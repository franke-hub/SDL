...
//----------------------------------------------------------------------------
void
   DHDL_sort<void>::debug(          // Debugging display
     const char*       info) const  // Caller information
{
   debugf("DHDL_sort<void>::debug(%s)\n", info);
...
//----------------------------------------------------------------------------
void
   DHDL_sort<void>::fifo(           // Insert _Link, FIFO order
     _Link*            link)        // -> _Link to insert
{
   link->_next= nullptr;            // Set next _Link pointer
   link->_prev= _tail;              // Set prior _Link pointer
...
//----------------------------------------------------------------------------
void
   DHDL_sort<void>::insert(         // Add to DHDL_sort<void> at position,
     _Link*            link,        // -> _Link to insert after
     _Link*            head,        // -> First _Link to insert
     _Link*            tail)        // -> Final _Link to insert
{
...
//----------------------------------------------------------------------------
bool                                // TRUE if _Link is in list
   DHDL_sort<void>::is_on_list(     // Is _Link contained?
     _Link*            link) const  // -> _Link
{
   if( link != nullptr )            // If a _Link was specified
   {
...
//----------------------------------------------------------------------------
void
   DHDL_sort<void>::lifo(           // Insert _Link, LIFO order
     _Link*            link)        // -> _Link to insert
{
   link->_next= _head;              // Set next _Link pointer
   link->_prev= nullptr;            // Set prior _Link pointer
...
//----------------------------------------------------------------------------
void
   DHDL_sort<void>::remove(         // Remove from list
     _Link*            head,        // -> First _Link to remove
     _Link*            tail)        // -> Final _Link to remove
{
   _Link* prev= head->_prev;        // _Link prior to head
...
//
//----------------------------------------------------------------------------
DHDL_sort<void>::_Link*             // -> Removed _Link
   DHDL_sort<void>::remq( void )    // Remove oldest _Link
{
   _Link* link= _head;              // Address the first _Link
   if( link != nullptr )            // If the list is not empty
   {
...
//
//----------------------------------------------------------------------------
DHDL_sort<void>::_Link*             // The set of removed _Links
   DHDL_sort<void>::reset( void )   // Reset (empty) the List
{
   _Link* link= _head;              // Resultant
...
//----------------------------------------------------------------------------
size_t                              // The number of links
   DHDL_sort<void>::size( void ) const // Get the _Link count
{
   size_t length= 0;
   for(_Link* link= _head; link; link= link->_next)
     ++length;
...
//----------------------------------------------------------------------------
void
   DHDL_sort<void>::sort( void )    // Sort the list
{
...
//
//----------------------------------------------------------------------------
DHDL_sort<void>::_Link*             // The set of removed _Links (left)
   DHDL_sort<void>::sort_split(     // Split the _Link set
...
//
//----------------------------------------------------------------------------
std::pair<DHDL_sort<void>::_Link*,DHDL_sort<void>::_Link*> // The combined set
   DHDL_sort<void>::sort_merge(     // Merge
