...
//       -out:name-of-logging-file (Default ./UpdateDNS.log) (Overwrite)
...
//       Currently only supports use=web.
//
//       Supports both duckdns and dyndns2 protocols.
//
//       Uses more or less standard control file format, i.e. name=value format
//       Example control file:
//           use=none               ## Get IP mechanism (implicit)
//           use=web                ## Get IP mechanism from myip-server
//           web=myip-server        ## Get IP server name, e.g. http://myip.dnsdynamic.org
//           protocol=dyndns2       ## Update protocol, dyndns2 or duckdns
//           server=update-server   ## Update server name, e.g. https://www.dnsdynamic.org
//           login=user-name        ## Login name, e.g. user@gmail.com
//           password=password      ## Password, e.g. PaSsWoRd (poor example)
//           the.target.name        ## Your IP name, e.g. awesome.dnsdynamic.org
//
//----------------------------------------------------------------------------
