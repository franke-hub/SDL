...
#include "gui/Pixmap.h"             // For gui::Pixmap (base class)
...
//----------------------------------------------------------------------------
// gui::Window::Constructors/Destructors/Operators
//----------------------------------------------------------------------------
protected:
   Window(                          // Constructor
...
//
// Method-
//       gui::Window::atom_to_name
//       gui::Window::name_to_atom
//
// Purpose-
...
//----------------------------------------------------------------------------
// gui::Window::Event handlers, overridden in implementation class.
//----------------------------------------------------------------------------
public:
virtual void
